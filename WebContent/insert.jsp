...
<body>
	<h3 style="font-weight: normal">
		...
		The team
		<%=teamName%>
		was correctly added. <br> <br> <a href="show.jsp?type=teams">Show
			teams list</a>
		<%
			}
		...
		<form action="insert.jsp" method="get">
			...
			Coach <input type="text" name="coach"><br> <br> <input
				type="hidden" name="type" value="teams"> <input
				type="submit" value="Insert" name="submit"><br>
		...
		<form action="insert.jsp" method="get">
			...
			<br> Visitor team <input type="text" name="visitorName"><br>
			<br> Visitor goals <input type="number" name="visitorGoals">
			<br> <br> <input type="hidden" name="type" value="matches">
