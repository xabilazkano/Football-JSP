...
<body>
	...
	<form action="modify.jsp?type=matches" method="get">
		...
		Visitor goals <input type="number" name="visitorGoals"> <input
			type="hidden" name="id" value="<%=id%>"><br> <br> <input
			type="hidden" name="type" value="matches"><input
			type="submit" value="Modify" name="submit"><br>
